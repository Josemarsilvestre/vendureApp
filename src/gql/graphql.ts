...
export type GetProductListQuery = { __typename?: 'Query', products: { __typename?: 'ProductList', items: Array<{ __typename?: 'Product', id: string, name: string, description: string, featuredAsset?: { __typename?: 'Asset', source: string } | null, variants: Array<{ __typename?: 'ProductVariant', priceWithTax: number, stockLevel: string, sku: string }>, collections: Array<{ __typename?: 'Collection', id: string }> }> } };
